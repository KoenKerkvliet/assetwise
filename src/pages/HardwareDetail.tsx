...
const ACTION_TYPES = ['storing', 'reparatie', 'melding', 'overig']
      ...
      <CardHeader className="pb-3">
        <div className="flex items-center justify-between">
          ...
          <Button size="sm" variant="outline" onClick={() => setShowNew(!showNew)}>
            <Plus className="mr-1 h-4 w-4" />{showNew ? 'Annuleren' : 'Nieuw incident'}
          </Button>
        </div>
      </CardHeader>
      <CardContent className="space-y-3">
              ...
              <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                <div className="space-y-1 sm:col-span-2">
                  ...
                  <Input
                    ...
                    placeholder="Korte omschrijving van het incident"
                  />
                </div>
                ...
                <div className="space-y-1">
                  ...
                  <Input
                    value={newForm.incident_number}
                    onChange={(e) => setNewForm({ ...newForm, incident_number: e.target.value })}
                ...
                <div className="space-y-1">
                  ...
                  <Input
                    value={newForm.involved}
                    onChange={(e) => setNewForm({ ...newForm, involved: e.target.value })}
                    placeholder="Optioneel"
                  />
                </div>
                <div className="space-y-1">
        ...
        {loading ? (
          ...
          <p className="py-4 text-center text-sm text-muted-foreground">
            Geen incidenten geregistreerd voor dit device.
          </p>
        ) : (
